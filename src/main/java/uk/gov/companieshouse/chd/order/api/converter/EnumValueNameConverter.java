package uk.gov.companieshouse.chd.order.api.converter;

/**
 * Factors out common enum name conversion to and from their JSON
 * representations. Ideally this class would be a bean, but the code to inject
 * into an enum is very verbose in Java.
 */
